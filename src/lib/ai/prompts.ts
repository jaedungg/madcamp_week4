...
작성할 내용: {prompt}`,
    examples: [
      {
        input: '회의 일정 조율 이메일',
        output: '안녕하세요. 평소 업무에 수고가 많으시겠습니다.\n\n다음 주 프로젝트 리뷰 회의 일정에 대해 조율드리고자 연락드립니다.\n현재 화요일 오후 2시와 목요일 오전 10시가 가능한 시간대인데, 어느 쪽이 더 편하실지 알려주시면 감사하겠습니다.\n\n회의 안건과 자료는 내일까지 메일로 공유드리겠습니다.\n\n감사합니다.'
      }
    ]
  },
